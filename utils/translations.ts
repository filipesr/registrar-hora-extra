...
export const translations = {
  pt: {
    ...
    selectEntryTime: 'Selecione hora e minuto de entrada',
    selectExitTime: 'Selecione hora e minuto de saída',
  ...
  es: {
    ...
    selectEntryTime: 'Seleccione hora y minuto de entrada',
    selectExitTime: 'Seleccione hora y minuto de salida',
